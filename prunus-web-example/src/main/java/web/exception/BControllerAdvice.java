...
public class BControllerAdvice extends MessageResolvedResponseEntityExceptionHandler implements Ordered {
    public BControllerAdvice(List<ExceptionMessageResolver> messageResolvers, BasicErrorController basicErrorController, ExceptionMessage errorMessageObject, ServerProperties serverProperties) {
